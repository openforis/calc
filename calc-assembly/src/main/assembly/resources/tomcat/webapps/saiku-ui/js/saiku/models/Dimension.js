...
var Measure = Backbone.Model.extend({
    ...
    parse: function(response) {
    	// sorting function added by M.Togna to see measures and calculated members sorted alphabetically in the measures section
    	response.sort( function(o1, o2) {
    		var string1 = o1.caption.toLowerCase(), string2 = o2.caption.toLowerCase();
