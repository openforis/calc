...
SELECT "plot_id_",
	...
	"no",
	"subplot",
	"plot_time_study_date",
	"plot_time_study_date_year",
	"plot_time_study_date_month",
	"plot_time_study_date_day",
	"time_study_start_time",
	"time_study_start_time_hour",
	"time_study_start_time_minute",
	"time_study_end_time",
	"time_study_end_time_hour",
	"time_study_end_time_minute",
	"share",
	"permanent",
	"group_leader",
	"plot_accessibility" as accessibility,
	"plot_accessibility_code_id_",
	"plot_region" as region,
	"plot_region_code_id_",
	"plot_district" as district,
	"plot_district_code_id_",
	"division",
	"ward",
	"village",
	"forest",
	...
	"land_use_other",
	"vegetation_type",
	"vegetation_type_code_id_",
	"vegetation_type_other",
	"ownership_type",
	"ownership_type_code_id_",
	"canopy_cover",
	"centre" as canopy_coverage_centre,
	"north" as canopy_coverage_north,
	"east" as canopy_coverage_east,
	"south" as canopy_coverage_south,
	"west" as canopy_coverage_west,
	"undergrowth_type",
	"undergrowth_type_code_id_",
	"undergrowth_type_other",
	"planting_year",
	"soil_structure",
	"soil_structure_code_id_",
	"soil_depth",
	"soil_colour",
	"soil_texture",
	"soil_texture_code_id_",
	"soil_texture_other",
	"sample",
	"erosion",
	"erosion_code_id_",
	...
	"catchment_code_id_",
	"plot_remarks",
	"slope_correction_applied",
	"coverage" as shrubs_coverage,
	"coverage_code_id_",
	"avg_height",
	"regen_remarks",
	"bamboo_remarks"
...
where 
        accessibility != '0'
    and
        exists (select tree_id_ from tree t where t.plot_id_ = _plot.plot_id_);
...
where 
        accessibility != '0'
    and
        exists (select stump_id_ from stump s where s.plot_id_ = _plot.plot_id_);
...
where 
        accessibility != '0'
    and
        exists (select dead_wood_id_ from dead_wood dw where dw.plot_id_ = _plot.plot_id_);
...
where 
        accessibility != '0'
    and
        exists (select bamboo_id_ from bamboo b where b.plot_id_ = _plot.plot_id_);
...
FROM cluster c
WHERE c.cluster_id_ = _plot.cluster_id_;
...
from pa
where _plot.plot_id_ = pa.plot_id_;
