...
-- fact table
drop table if exists naforma1._damage_occurrence cascade;
    
create table naforma1._damage_occurrence as 
SELECT distinct
    p.country_id,
    p.zone_id,
    p.region_id,
...
--- Country
drop table if exists naforma1._country_damage_agg cascade;
    
create table naforma1._country_damage_agg as 
SELECT
    p.country_id,
    p.stratum,
    p.vegetation_type,
