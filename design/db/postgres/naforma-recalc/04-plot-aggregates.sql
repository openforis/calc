...
drop table if exists naforma1._country_stratum_plot_agg cascade;
...
drop table if exists naforma1._country_plot_agg cascade;
...
drop table if exists naforma1._zone_stratum_plot_agg cascade;
...
drop table if exists naforma1._zone_plot_agg cascade;
...
drop table if exists naforma1._region_stratum_plot_agg cascade;
...
drop table if exists naforma1._region_plot_agg cascade;
...
drop table if exists naforma1._district_stratum_plot_agg cascade;
...
drop table if exists naforma1._district_plot_agg cascade;
