...
create table "calc"."dbtable" (
  ...
  primary key ("id"));
comment on column "calc"."dbtable"."type" is 'data, code_list';
create table "calc"."dbcolumn" (
  "id"            serial not null, 
  ...
  primary key ("id"));
comment on column "calc"."dbcolumn"."type" is 'e.g. id, parent_id, date, location, location_x, location_y, srsid, remarks, shape, etc.';
...
alter table "calc"."dbcolumn" add constraint "column_metadata_table_fkey" foreign key ("table_id") references "calc"."dbtable" ("id");
alter table "calc"."entity" add constraint "entity_data_table_fkey" foreign key ("data_table_id") references "calc"."dbtable" ("id");
alter table "calc"."variable" add constraint "variable_code_list_table_fkey" foreign key ("code_list_table_id") references "calc"."dbtable" ("id");
alter table "calc"."variable" add constraint "FKvariable342421" foreign key ("value_column_id") references "calc"."dbcolumn" ("id");
...
alter table "calc"."dbtable" add constraint "FKdbtable788482" foreign key ("workspace_id") references "calc"."workspace" ("id");
