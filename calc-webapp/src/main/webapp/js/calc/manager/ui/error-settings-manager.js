...
ErrorSettingsManager = function( container ) {
	...
	this.errorSettings 	= this.container.find( ".error-settings" );
	this.errorSettings.hide();
...
//	this.classes	= this.container.find( ".classes" );
	this.saveBtn 		= this.container.find( ".view-btn button" );
...
ErrorSettingsManager.prototype.bindEvents = function() {
	var $this = this;
...
ErrorSettingsManager.prototype.resetUi = function() {
...
//						var div = $( '<div class="option col-md-11" style="padding-bottom: 2px"></div>' );
...
//						var divBtn = $( '<div class="option col-md-1" style="padding-bottom: 2px"></div>' );
