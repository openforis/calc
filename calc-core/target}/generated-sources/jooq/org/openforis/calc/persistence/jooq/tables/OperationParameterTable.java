...
public class OperationParameterTable extends org.jooq.impl.UpdatableTableImpl<org.openforis.calc.persistence.jooq.tables.records.OperationParameterRecord> {

	private static final long serialVersionUID = 596517301;

	/**
	 * The singleton instance of calc.operation_parameter
	 */
	public static final org.openforis.calc.persistence.jooq.tables.OperationParameterTable OPERATION_PARAMETER = new org.openforis.calc.persistence.jooq.tables.OperationParameterTable();
	 ...
	 */
	public final org.jooq.TableField<org.openforis.calc.persistence.jooq.tables.records.OperationParameterRecord, java.lang.Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER, this);
	 ...
	 */
	public final org.jooq.TableField<org.openforis.calc.persistence.jooq.tables.records.OperationParameterRecord, java.lang.String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR, this);

	/**
	 * The table column <code>calc.operation_parameter.value</code>
	 */
	public final org.jooq.TableField<org.openforis.calc.persistence.jooq.tables.records.OperationParameterRecord, java.lang.String> VALUE = createField("value", org.jooq.impl.SQLDataType.VARCHAR, this);

	public OperationParameterTable() {
		super("operation_parameter", org.openforis.calc.persistence.jooq.CalcTable.CALC);
	}

	public OperationParameterTable(java.lang.String alias) {
		super(alias, org.openforis.calc.persistence.jooq.CalcTable.CALC, org.openforis.calc.persistence.jooq.tables.OperationParameterTable.OPERATION_PARAMETER);
	}
	...
	public java.util.List<org.jooq.ForeignKey<org.openforis.calc.persistence.jooq.tables.records.OperationParameterRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<org.openforis.calc.persistence.jooq.tables.records.OperationParameterRecord, ?>>asList(org.openforis.calc.persistence.jooq.Keys.OPERATION_PARAMETER__FK_OPERATION_PARAMETER_PROCESS);
	}

	@Override
	public org.openforis.calc.persistence.jooq.tables.OperationParameterTable as(java.lang.String alias) {
		return new org.openforis.calc.persistence.jooq.tables.OperationParameterTable(alias);
	}
}
