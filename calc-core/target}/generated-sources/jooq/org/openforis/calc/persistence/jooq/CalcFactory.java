 ...
 * This class is generated by jOOQ.
 *
 * A Factory for specific use with the <code>calc</code> schema.
 * <p>
 * This Factory will not render the <code>calc</code> schema's schema name 
...
public class CalcFactory extends org.jooq.util.postgres.PostgresFactory {

	private static final long serialVersionUID = 1094955106;
	 ...
	 */
	public CalcFactory(java.sql.Connection connection) {
		super(connection);
	 ...
	 */
	public CalcFactory(javax.sql.DataSource dataSource) {
		super(dataSource);
	 ...
	 */
	public CalcFactory(java.sql.Connection connection, org.jooq.conf.Settings settings) {
	 ...
	 * @param settings The settings to apply to objects created from this factory
	 */
	public CalcFactory(javax.sql.DataSource dataSource, org.jooq.conf.Settings settings) {
	...
	private final void initDefaultSchema() {
		org.jooq.conf.SettingsTools.getRenderMapping(getSettings()).setDefaultSchema(org.openforis.calc.persistence.jooq.CalcTable.CALC.getName());
	}
}
