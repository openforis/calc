 ...
 * 
 */
public class OldFactTable extends DataTable {
	...
	private OldFactTable parentTable;
	private Map<AoiHierarchy, List<AggregateTable>> aggregateTables;

	protected OldFactTable(Entity entity, String name, Schema schema, DataTable sourceTable, OldFactTable parentTable) {
		super(entity, name, schema);
	}
	
	OldFactTable(Entity entity, Schema schema, OutputTable sourceOutputTable, OldFactTable parentTable) {
...
//	}
	...
	public OldFactTable getParentTable() {
		return parentTable;
	}
