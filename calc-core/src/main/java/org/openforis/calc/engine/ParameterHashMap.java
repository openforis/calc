...
public class ParameterHashMap implements ParameterMap {
	 ...
	 * Wraps the given Map
	 * 
	 * WARNING: Does not defensively copy the map; Changes to ParameterHashMap pass through to the original map and vice-versa
	 * 
	 * @param map
	 */
	...
	/**
	 * WARNING: Does not defensively copy the map; Changes to this map value pass through to the original map and vice-versa
	 * 
	 * @param map
	 */
	@Override
