...
public class Table {
    ...
    public Table(VariableMetadata variableMetadata) {
    	setName( variableMetadata.getVariableName() );
    	
    	ObservationUnitMetadata obsUnitMetadata = variableMetadata.getObservationUnitMetadata();
		SurveyMetadata surveyMetadata = obsUnitMetadata.getSurveyMetadata();
		String surveyName = surveyMetadata.getSurveyName();
		
		setSchema( surveyName );
	}
